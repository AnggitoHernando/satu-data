...
import { SendIcon, SearchIcon } from "lucide-vue-next";
...
<template>
    ...
    <PpidLayout :is-contrast-mode="isContrastMode">
        <section
            class="bg-green-800 text-white py-16 shadow-md md:py-20 text-center transition-all"
        >
                    ...
                    <template #body>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <RadioPilGroup
                                    class="mt-2"
                                    v-model="form.cara_mendapatkan_informasi"
                                    :options="caraMendapatkanInformasi"
                                    :cols="3"
                                />
                                <InputError
                                    :message="
                                        form.errors.cara_mendapatkan_informasi
                                    "
                                    class="mt-2"
                                />
                            </div>
